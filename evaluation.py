...
def plot_roc(model, y_test, features):
    ...
    fpr = metrics.roc_curve(y_true=y_test, y_score=probs)[0]
    tpr = metrics.roc_curve(y_true=y_test, y_score=probs)[1]
    roc_auc = metrics.roc_auc_score(y_true=y_test, y_score=probs)
